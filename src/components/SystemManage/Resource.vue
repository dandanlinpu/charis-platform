  ...
  <el-col :span="24">
    <div class="TablePanel">
      ...
      <el-table class="TableFrame" :data="$store.state.resource.resourceList" @selection-change="handleSelectionChange"
        ...
        <el-table-column prop="name" label="资源名称" width="130">
        ...
        <el-table-column prop="scope" label="范围" width="60" align="center">
          <template slot-scope="scope">{{scope.row.scope}}</template>
        </el-table-column>
        <el-table-column prop="description" label="描述" width="282">
        ...
        <el-table-column prop="last_modified_by" label="最后修改" width="80" align="center">
          <template slot-scope="scope"><span style="margin-left: 10px">{{ scope.row.lastModifiedBy }}</span></template>
        </el-table-column>
